...
def apply_discount(total_price, additional_item_count):
    discount = 0.0
...
# Apply discount
additional_item_count = len(additional_prices)
discount = apply_discount(total_price, additional_item_count)
...
print("---------------------")
print(f"Number of Additional Items: {additional_item_count}")
print(f"Discount Applied: ${discount}")
print(f"Amount Saved: ${discount}")
print(f"New Price of the Computer: ${total_price}")